...
export default {
  ...
  edit: {
    ...
    invalidManagedOverridesTitle:
      '有 {n} 项在 MAS 里改过的设置已失效，运行时会被忽略、按三月七 / SRA 里的设置执行',
    ...
    clearInvalidManagedOverridesConfirm:
      '删掉这 {n} 项失效的设置？三月七 / SRA 里的设置不会被修改。',
    matchesOnly: '仅显示已命中',
    never: '从不',
    sanityScriptChangedPick: '体力模块的执行引擎已切换，请重新选择副本。',
    hsrStageMissingForEngine: '{engine} 下还没选副本',
    editHsrUser: '编辑 HSR 用户',
    addHsrUser: '添加 HSR 用户',
    hsrWeekDone: '本周已完成',
    hsrWeekNotDone: '本周未完成',
    hsrLastCompleted: '最近完成：{date}',
    hsrUseScriptShared: '和本脚本里其他选了「脚本」的用户共用同一份任务配置。',
    hsrSharedPlanHint: '当前编辑的是脚本共享任务配置，会影响本脚本里所有选了「脚本」的用户。',
    ...
    hsrNativeConfigNotLoaded: '还没读到三月七 / SRA 里的设置',
    hsrRepickStage: '请重新选择副本',
    hsrTaskConfig: '任务配置',
    hsrSharedPlanTag: '脚本共享',
    hsrSummaryNative: '沿用{engine}里的设置',
    hsrSummaryItem: '{label}：{value}',
    hsrSummaryMore: '{text}，另 {n} 项',
    hsrValueOn: '开',
    hsrValueOff: '关',
    hsrValueEmpty: '（空）',
    hsrDailySummary: '{type} · {stage}｜历战余响：{eow}（{weekday}）',
    hsrStageNotPicked: '未选择副本',
    hsrStageType: '副本类型',
    hsrStage: '副本',
    hsrBuildTargetIgnoredSra: '已开启「{label}」：SRA 按培养目标决定刷什么，这里选的副本不会执行。',
    hsrBuildTargetFallbackM7a:
      '已开启「{label}」：三月七优先按培养目标刷取，识别不到时才刷这里选的副本。',
    hsrFieldOverridden: '已改',
    hsrFieldNativeValue: '在 MAS 里改过，原值：{value}',
    hsrFieldReset: '恢复',
    hsrFieldResetFailed: '恢复失败',
    hsrListEmpty: '还没有条目',
    hsrAddRow: '添加一行',
    hsrRemoveRow: '删除这一行',
    hsrInstanceName: '副本名称',
    hsrTeamNumber: '队伍号',
    hsrBorrowCharacter: '角色名',
    hsrBorrowFriend: '好友名',
    hsrFieldGroup: {
      common: '常用',
      team: '队伍',
    ...
    hsrGroupOverriddenCount: '已改 {n} 项',
    hsrNoticeExpand: '查看详情',
    hsrNoticeCollapse: '收起',
    ...
    hsrModuleResetConfirmUser:
      '删掉这个用户在 MAS 里对本模块改过的设置（只影响当前引擎）；三月七 / SRA 里的设置本身不会被修改。此操作无法撤销。',
    hsrModuleResetConfirmShared:
      '删掉共享任务配置里对本模块改过的设置（只影响当前引擎），选了「脚本」的用户都会受影响；三月七 / SRA 里的设置本身不会被修改。此操作无法撤销。',
    hsrModuleResetDone: '本模块已恢复为{engine}里的设置',
    hsrModuleResetFailed: '恢复本模块为{engine}里的设置失败',
    hsrMarkNotDone: '标记未完成',
    hsrUseUserOwn: '这个用户单独一份任务配置，不影响其他用户。',
    hsrUseDirect:
      '直接运行三月七 / SRA 里保存的设置，MAS 只负责启动游戏和收尾；本页的任务配置不生效。',
    hsrNoEnginePath: '请先在脚本设置里填写三月七或 SRA 的路径。',
    hsrCapabilityFallback: '读取引擎状态失败，已按脚本设置里填写的路径显示：{reason}',
    notConfigured: '未配置',
    howUseThis: '使用说明',
    ...
    always: '总是',
    success: '成功时',
    engineReturnedNoDynamic: '没读到该引擎对这个模块的设置。请在该引擎里保存一次设置后刷新本页。',
    run: '执行',
    folder: '文件夹',
    ...
    startDayIfIt:
      '到达开始日且本周未完成时，MAS 会交给三月七 / SRA 尝试完成历战余响；日志确认完成后本周不再执行。',
    ...
    invalidManagedOverridesCleared: '已清除 {n} 项失效的设置',
    ...
    calyxCrimson: '拟造花萼（赤）',
    calyxCrimsonTraceMaterials: '拟造花萼（赤）：行迹材料',
    calyxGolden: '拟造花萼（金）',
    ...
    hsrConfigRestoreScriptDesc:
      'HSR 原生配置的备份（三月七 config.yaml 与 SRA settings/cache/configs），恢复会直接覆盖原生配置；进入本编辑页或运行前会自动去重创建，保留最近 10 份',
    // BAAH 专项
    ...
    // 奇想盒专项
    whimboxScriptConfiguration: '奇想盒脚本配置',
    whimboxInstanceNameHint: '用于区分不同的奇想盒脚本实例',
    whimboxPath: '奇想盒安装目录',
    whimboxPickExeDir:
      '选择 whimbox_app.exe 所在目录（奇想盒默认安装目录）；configs 与 logs 目录与其同级',
    whimboxPickExeDirPlaceholder: '请选择奇想盒安装目录（whimbox_app.exe 所在目录）',
    whimboxPathRequired: '请选择奇想盒安装目录',
    whimboxRootPathSaved: '奇想盒安装目录已保存',
    whimboxInvalidDirectory: '所选目录无效',
    whimboxExeNotFound: '所选目录下未找到 {p0}，请选择奇想盒的安装根目录',
    whimboxNotWhimboxScript: '脚本类型不是奇想盒',
    whimboxRetryLimitHint: '单次运行失败后的重试次数上限；一条龙步骤内的可恢复失败不会消耗重试',
    whimboxRunTimeoutHint:
      '日志持续这么久没有新进展（分钟）即判定卡死并中止；一条龙多账号全循环耗时较长，请按需调大',
    whimboxUseAdmin: '以管理员运行',
    whimboxUseAdminHint:
      '奇想盒后端强制管理员权限，保持开启即可；本软件已以管理员运行时不会重复弹 UAC',
    whimboxUserTag: '用户标签',
    whimboxUserTagHint: '由本软件按运行情况自动生成，仅供查看',
    whimboxOneDragonSection: '一条龙流程',
    whimboxTaskSection: '任务配置',
    whimboxFlowNodes: '流程节点',
    whimboxStepsEmpty: '未读取到步骤开关',
    whimboxOptionsEmpty: '未读取到目标或参数',
    whimboxOptionsSection: '高级参数',
    whimboxRunAllAccounts: '循环全部游戏账号',
    whimboxRunAllAccountsHint:
      '开启后一条龙会依次切换游戏内已登录的全部账号逐个执行；账号列表由奇想盒自动识别，无需在 MAS 里登记',
    whimboxStepHint:
      '步骤与目标列表由奇想盒版本自动下发（升级奇想盒后刷新本页即可看到新增步骤）；启动游戏、进入游戏等必经步骤由奇想盒固定执行，不在此列',
    whimboxSelectPlaceholder: '请选择',
    whimboxMultiSelectPlaceholder: '可多选',
    whimboxTextPlaceholder: '请输入',
  ...
  misc: {
    ...
    backgroundInitDegradedTitle: '部分后台服务启动失败',
    backgroundInitFailedTitle: '后台服务启动失败',
    backgroundInitTimerStarted: '定时任务已正常启动；下列功能可能暂不可用，重启软件后会重试。',
    backgroundInitTimerNotStarted: '定时任务可能未启动，队列不会按计划时间运行，请重启软件。',
    backgroundInitFailedSteps: '失败项：{steps}',
  ...
  scripts: {
    ...
    mask: {
      ...
      whimboxTitle: '正在进行奇想盒原生设置',
      whimboxDesc: '请在奇想盒里完成设置：下载跑图路线、配置模型与键位等。',
      whimboxUnlockTip:
        '完成后点击“保存设置”结束本次会话（MAS 不写入原生配置，会话前后各归档一次快照）。',
      saveConfig: '保存配置',
      saveSettings: '保存设置',
    },
    createMode: {
  ...
  setting: {
    ...
    notify: {
      ...
      openclawQqSetupHint:
        '扫码绑定后，请在扫码所用 QQ 中添加该机器人为好友，再发送测试通知。登录信息会自动保存。',
      openclawQqBind: '扫码绑定',
